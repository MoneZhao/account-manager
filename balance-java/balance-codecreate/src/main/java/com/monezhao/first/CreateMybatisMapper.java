...
public class CreateMybatisMapper {
    ...
    public static void create(String createTableName, String templetPath) {
        ...
        // 读取模板内容
        File serviceFile = new File(CodeUtil.projectPath + "balance-codecreate/src/main/java/com/monezhao/template/" + templetPath + "/Mapper.txt");
        try {
        ...
        try {
            String filePath = CodeUtil.projectPath + CodeUtil.module
                    + "/src/main/java/com/monezhao/module/" + sys + "/mapper/";
