...
public class CreateVue {
    ...
    private static void writeFile(StringBuffer stringBufferAll, String sysUpper, String sys, String aSys, String aCodeType, String codeType,
        ...
        try {
            String filePath = CodeUtil.projectPath + "balance-manager/src/main/resources/templates/" + sys + "/" + codeType + "/";
    ...
    private static void readStringBufferAll(String templetPath, StringBuffer stringBufferAll) {
        // 读取模板内容
        File actionFile = new File(CodeUtil.projectPath + "balance-codecreate/src/main/java/com/monezhao/template/" + templetPath + "/Vue.txt");
