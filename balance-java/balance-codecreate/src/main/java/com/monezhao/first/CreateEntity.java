...
public class CreateEntity {
    ...
    public static void create(String createTableName) {
        ...
        for (Object tableName : hashMap.keySet()) {
            ...
            // package部分
            stringBufferHead.append("package com.monezhao.bean." + sys + ";" + "\r\n\r\n");
            ...
            importHashMap.put("import com.monezhao.common.base.BaseEntity;\r\n",
        ...
        // 实体类.
        try {
            String filePath = CodeUtil.projectPath + "balance-module/src/main/java/com/monezhao/bean/" + sys + "/";
