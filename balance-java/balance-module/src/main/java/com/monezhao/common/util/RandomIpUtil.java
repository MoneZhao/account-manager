...
public class RandomIpUtil {
    ...
    /**
     * @param number ip number
     * @return ip list
     */
    public static Set<String> getRandomIp(int number) {
        Random random = new Random();
        Set<String> list = new HashSet<>(number);
     ...
     * @return ip list
     */
    public static Set<String> getRandomIp() {
        int number = new Random().nextInt(5) + 1;
        return getRandomIp(number);
    }
