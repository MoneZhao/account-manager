...
CreateAndReferenceElementHandler.prototype.execute = function(context) {
  ...
  var referenceProperty = ensureNotNull(context.referenceProperty, 'referenceProperty')
  var newObject = ensureNotNull(context.newObject, 'newObject')
  var newObjectContainer = ensureNotNull(context.newObjectContainer, 'newObjectContainer')
  var newObjectParent = ensureNotNull(context.newObjectParent, 'newObjectParent')
...
CreateAndReferenceElementHandler.prototype.revert = function(context) {
  ...
  var referenceProperty = context.referenceProperty
  var previousReference = context.previousReference
  var referencedObject = context.referencedObject
  var newObjectContainer = context.newObjectContainer
