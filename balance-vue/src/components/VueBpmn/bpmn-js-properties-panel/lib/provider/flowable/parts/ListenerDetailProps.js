...
var scriptImplementation = require('./implementation/Script')
var timerImplementation = require('bpmn-js-properties-panel/lib/provider/bpmn/parts/implementation/TimerEventDefinition')
...
module.exports = function(group, element, bpmnFactory, options, translate) {
  ...
  var classProp = 'class'
  var expressionProp = 'expression'
  var delegateExpressionProp = 'delegateExpression'
  var scriptProp = 'script'
  ...
  group.entries.push(entryFactory.selectBox({
    ...
    set: function(element, values, node) {
      ...
      var listener = getSelectedListener(element, node)
      var eventDefinitions = listener && listener.eventDefinitions
  ...
  group.entries.push(entryFactory.selectBox({
    ...
    set: function(element, values, node) {
      var listener = getSelectedListener(element, node)
      var listenerType = values.listenerType || undefined
      var update = {}
