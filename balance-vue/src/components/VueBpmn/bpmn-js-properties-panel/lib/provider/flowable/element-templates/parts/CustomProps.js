...
var findFlowableProperty = require('../Helper').findFlowableProperty
var findFlowableInOut = require('../Helper').findFlowableInOut
...
var createFlowableIn = require('../CreateHelper').createFlowableIn
var createFlowableOut = require('../CreateHelper').createFlowableOut
var createFlowableInWithBusinessKey = require('../CreateHelper').createFlowableInWithBusinessKey
var createFlowableFieldInjection = require('../CreateHelper').createFlowableFieldInjection

var FLOWABLE_PROPERTY_TYPE = 'flowable:property'
var FLOWABLE_INPUT_PARAMETER_TYPE = 'flowable:inputParameter'
var FLOWABLE_OUTPUT_PARAMETER_TYPE = 'flowable:outputParameter'
var FLOWABLE_IN_TYPE = 'flowable:in'
var FLOWABLE_OUT_TYPE = 'flowable:out'
var FLOWABLE_IN_BUSINESS_KEY_TYPE = 'flowable:in:businessKey'
var FLOWABLE_EXECUTION_LISTENER_TYPE = 'flowable:executionListener'
var FLOWABLE_FIELD = 'flowable:field'
