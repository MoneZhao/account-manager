...
var removeEntry = require('../../../helper/ExtensionElementsHelper').removeEntry
...
module.exports = function(group, element, bpmnFactory, translate) {
  ...
  group.entries.push(entryFactory.table({
    ...
    removeElement: function(element, node, idx) {
      var selectedFormField = getSelectedFormField(element, node)
      var enumValue = selectedFormField.values[idx]
  ...
  group.entries.push(entryFactory.table({
    ...
    addElement: function(element, node) {
      var commands = []
      var formField = getSelectedFormField(element, node)
      var validation = formField.validation
    ...
    updateElement: function(element, value, node, idx) {
      var formField = getSelectedFormField(element, node)
      var constraint = formHelper.getConstraints(formField)[idx]
    ...
    removeElement: function(element, node, idx) {
      var commands = []
      var formField = getSelectedFormField(element, node)
      var constraints = formHelper.getConstraints(formField)
