...
var domRemove = require('min-dom').remove
...
PropertiesPanel.prototype.activateTab = function(tab) {
  ...
  forEach(allTabLinkNodes, function(tabLinkNode) {
    ...
    var currentTabId = domAttr(tabLink, 'data-tab-target')
...
PropertiesPanel.prototype._createPanel = function(element, tabs) {
  ...
  var tabBarNode = domify('<div class="bpp-properties-tab-bar el-tabs"></div>')
  var tabLinksNode = domify('<ul class="bpp-properties-tabs-links"></ul>')
  var tabContainerNode = domify('<div class="bpp-properties-tabs-container"></div>')
