  ...
  <div class="cron-box">
    <el-tabs v-model="activeName" type="border-card" stretch>
      <el-tab-pane label="秒" name="s">
        <Time lable="秒" @time="second" />
      </el-tab-pane>
      <el-tab-pane label="分" name="m">
        <Time lable="分" @time="minute" />
      </el-tab-pane>
      <el-tab-pane label="时" name="h">
        <Time lable="时" @time="hour" />
      </el-tab-pane>
      <el-tab-pane label="日(周)" name="d">
        <day lable="日" @dayAndWeek="dayAndWeek" />
      </el-tab-pane>
      <el-tab-pane label="月" name="month">
        <month lable="月" @month="month" />
      </el-tab-pane>
      <el-tab-pane label="年" name="year">
        <year lable="年" @year="year" />
      </el-tab-pane>
    </el-tabs>
    <div class="table-box">
