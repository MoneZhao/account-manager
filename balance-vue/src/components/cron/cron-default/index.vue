          ...
          <div class="box-bottom cycle">
            ...
            <div style="margin-top:8px;">
              ...
              >
                ...
                <el-option label="一" :value="'2'" />
                <el-option label="二" :value="'3'" />
                <el-option label="三" :value="'4'" />
                <el-option label="四" :value="'5'" />
                <el-option label="五" :value="'6'" />
                <el-option label="六" :value="'7'" />
              </el-select>
              <el-input-number
