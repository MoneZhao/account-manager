    ...
    <el-row :gutter="5">
      ...
      <el-col :span="14">
        <div class="filter-container">
          ...
          <el-button-group>
            <el-button v-permission="'sys:codeInfo:save'" icon="el-icon-plus" type="primary" class="filter-item" @click="btnCodeInfoCreate">新增</el-button>
            <el-button v-permission="'sys:codeInfo:delete'" icon="el-icon-delete" class="filter-item" @click="btnCodeInfoDelete()">批量删除</el-button>
          </el-button-group>
        </div>
        <el-table
          ref="codeInfoTable"
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" :disabled="dialogStatus==='view'" label-position="right" label-width="auto">
        ...
        <el-form-item label="是否显示" prop="isOk">
          <el-select v-model="temp.isOk" placeholder="是否显示">
            <el-option v-for="item in dicts.yesOrNo" :key="item.value" :label="item.content" :value="item.value" />
          </el-select>
        </el-form-item>
