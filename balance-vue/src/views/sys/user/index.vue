<template>
  <div class="app-container">
          ...
          <el-col :span="12">
            ...
            <el-form-item label="所属机构" prop="orgName">
              <el-input v-model="temp.orgName">
                <el-button slot="append" icon="el-icon-search" @click="btnSelectOrg" />
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="用户状态" prop="status">
              <el-select v-model="temp.status" placeholder="用户状态">
                <el-option v-for="item in dicts.userStatus" :key="item.value" :label="item.content" :value="item.value" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
    ...
    <el-dialog title="配置快捷方式" :visible.sync="showShortCutModal" destroy-on-close>
      <short-cut v-if="showShortCutModal" ref="shortCut" :role-id="temp.roleId" :user-id="temp.userId" @shortCutEnd="shortCutEnd" @shortCutWarning="shortCutWarning" />
      <div slot="footer" class="dialog-footer">
