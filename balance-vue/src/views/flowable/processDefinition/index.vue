<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button-group>
        <el-button v-permission="'flowable:processDefinition:import'" icon="el-icon-plus" type="primary" class="filter-item" @click="btnImport">导入</el-button>
      </el-button-group>
    </div>
    <el-table
      ref="multipleTable"
    ...
    <process-image
      v-if="dialogProcessImageVisible"
      :visible.sync="dialogProcessImageVisible"
      :process-definition-id="selectedProcessDefinitionId"
    />

    <process-definition-identity-link
      v-if="dialogProcessDefinitionIdentityLinkVisible"
      :visible.sync="dialogProcessDefinitionIdentityLinkVisible"
      :process-definition-id="selectedProcessDefinitionId"
      :process-definition-name="selectedProcessDefinitionName"
    />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    btnSuspendOrActivate(processDefinitionId, suspend) {
      const suspendOrActivate = suspend ? 'activate' : 'suspend'
