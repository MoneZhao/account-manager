  ...
  <div class="app-container">
    <div class="filter-container">
      <div class="filter-container">
        ...
        <el-button icon="el-icon-zoom-out" type="primary" style="margin-left: 10px" @click="btnReset">重置</el-button>
      </div>
    </div>
    <el-row>
      <el-col v-for="(row, index1) in myInvolvedRecords" :key="index1" :span="12">
          ...
          <el-card>
            <div slot="header" class="clearfix">
              ...
              >
                <el-link type="primary">
                  {{ formatDictText(dicts.processCategory, row.categoryName) }}
                </el-link>
              </router-link>
            </div>
            ...
            <div style="height: 110px;padding-left: 15px">
              <el-scrollbar class="scroll-container">
                <router-link
                  v-for="(item, index2) in row.processDefinitionVoList"
                  :key="index2"
