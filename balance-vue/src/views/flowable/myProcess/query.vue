<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <div>
        <el-select v-model="listQuery.processDefinitionCategory" placeholder="流程分类" class="filter-item">
          <el-option
        ...
        <el-input
          ...
          @keyup.enter.native="btnMyInvolvedQuery"
        />
        <el-dropdown split-button type="primary" class="filter-item" @click="btnMyInvolvedQuery">
