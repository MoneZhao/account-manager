<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button-group>
        <el-button icon="el-icon-plus" type="primary" class="filter-item" @click="btnRead()">批量已阅</el-button>
      </el-button-group>
    </div>
    <el-table
      :data="records"
...
export default {
  ...
  methods: {
    ...
    btnRead(id) {
      const taskIds = id ? [id] : this.selectedRecords.map(record => {
        return record.id
      })
      if (taskIds.length == 0) {
