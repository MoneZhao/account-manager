<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button-group>
        <el-button
          v-permission="'flowable:form:save'"
          icon="el-icon-plus"
          type="primary"
          class="filter-item"
          @click="btnCreate"
        ...
        <el-button
          v-permission="'flowable:form:delete'"
          icon="el-icon-delete"
          class="filter-item"
          @click="btnDelete()"
        >批量删除
        ...
        <template slot-scope="{row}">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item
                v-permission="'flowable:form:update'"
                icon="el-icon-edit"
                divided
              ...
              <el-dropdown-item
                ...
                icon="el-icon-edit"
                divided
                @click.native="btnUpdateFormJson(row)"
              >修改表单
              </el-dropdown-item>
              <el-dropdown-item
                v-permission="'flowable:form:delete'"
                icon="el-icon-delete"
                divided
                @click.native="btnDelete(row.formKey)"
              >删除
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
