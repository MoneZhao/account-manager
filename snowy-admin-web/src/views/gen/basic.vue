      ...
      <a-row :gutter="16">
        ...
        <a-col :span="8">
          <a-form-item name="pluginName">
            ...
            <a-input v-model:value="formData.pluginName" allow-clear placeholder="请输入插件名" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item label="包名：" name="packageName">
            <a-input v-model:value="formData.packageName" allow-clear placeholder="请输入包名" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item name="moduleName">
            ...
            <a-input v-model:value="formData.moduleName" allow-clear placeholder="请输入模块名" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
        ...
        <a-col :span="8">
          <a-form-item label="排序：" name="sortCode">
            <a-input-number v-model:value="formData.sortCode" :max="100" style="width: 100%" />
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
  ...
  const selectTableColumnsData = (tableName, assign) => {
    ...
    genBasicApi.basicTableColumns(param).then((data) => {
      tableColumns.value = data.map((item) => {
        if (item['columnName'].toLowerCase() === 'id') {
          formData.value.dbTableKey = item['columnName']
        }
        return {
