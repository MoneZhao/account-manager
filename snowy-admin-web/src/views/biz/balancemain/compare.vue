<template>
  <xn-form-container title="余额对比" :width="700" :visible="visible" :destroy-on-close="true" @close="onClose">
...
<script setup name="compare">
  ...
  const onChangeTime = () => {
    formRef.value.validate().then(() => {
      ...
      bizBalanceMainApi
        .bizBalanceMainCompare(formDataParam)
        .then((data) => {
          if (data.account) {
