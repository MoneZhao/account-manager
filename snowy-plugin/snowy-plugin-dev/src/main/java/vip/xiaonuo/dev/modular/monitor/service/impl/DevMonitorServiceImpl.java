...
public class DevMonitorServiceImpl implements DevMonitorService {
    ...
    public DevMonitorServerResult serverInfo() {
        ...
        // CPU信息
        CompletableFuture<DevMonitorServerResult.DevMonitorCpuInfo> task1 = CompletableFuture.supplyAsync(() -> {
...
//            log.info("CpuInfo: {}", JSONUtil.toJsonStr(devMonitorCpuInfo));
            return devMonitorCpuInfo;
        });


        // 内存信息
        CompletableFuture<DevMonitorServerResult.DevMonitorMemoryInfo> task2 = CompletableFuture.supplyAsync(() -> {
...
//            log.info("MemoryInfo: {}", JSONUtil.toJsonStr(devMonitorMemoryInfo));
            return devMonitorMemoryInfo;
        });

        // 存储信息
        CompletableFuture<DevMonitorServerResult.DevMonitorStorageInfo> task3 = CompletableFuture.supplyAsync(() -> {
...
//            log.info("StorageInfo: {}", JSONUtil.toJsonStr(devMonitorStorageInfo));
            return devMonitorStorageInfo;
        });

        // 网络信息
        CompletableFuture<DevMonitorServerResult.DevMonitorNetworkInfo> task4 = CompletableFuture.supplyAsync(() -> {
...
//            log.info("NetworkInfo: {}", JSONUtil.toJsonStr(devMonitorNetworkInfo));
            return devMonitorNetworkInfo;
        });

        // 服务器信息
        CompletableFuture<DevMonitorServerResult.DevMonitorServerInfo> task5 = CompletableFuture.supplyAsync(() -> {
...
//            log.info("ServerInfo: {}", JSONUtil.toJsonStr(devMonitorServerInfo));
            return devMonitorServerInfo;
        });

        // JVM信息
        CompletableFuture<DevMonitorServerResult.DevMonitorJvmInfo> task6 = CompletableFuture.supplyAsync(() -> {
...
//            log.info("JvmInfo: {}", JSONUtil.toJsonStr(devMonitorJvmInfo));
            return devMonitorJvmInfo;
        });


        try {
            CompletableFuture.allOf(task1, task2, task3, task4, task5, task6).get();
            devMonitorServerResult.setDevMonitorCpuInfo(task1.get());
            devMonitorServerResult.setDevMonitorMemoryInfo(task2.get());
            devMonitorServerResult.setDevMonitorStorageInfo(task3.get());
            devMonitorServerResult.setDevMonitorNetworkInfo(task4.get());
            devMonitorServerResult.setDevMonitorServerInfo(task5.get());
            devMonitorServerResult.setDevMonitorJvmInfo(task6.get());
